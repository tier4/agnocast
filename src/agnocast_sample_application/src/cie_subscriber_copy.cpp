...
public:
  explicit CieSubscriber(const rclcpp::NodeOptions & options)
  : Node("minimal_subscriber_copy", options)
  {
    ...
    sub_dynamic_ = agnocast::create_subscription<agnocast_sample_interfaces::msg::DynamicSizeArray>(
      ...
      [](
        ...
        RCLCPP_INFO(
          ...
          "receive message id=%ld in group1 from /my_topic_copy", message->id);
      },
      agnocast_options);
    ...
    sub_ros_ = this->create_subscription<agnocast_sample_interfaces::msg::DynamicSizeArray>(
      ...
      [](const agnocast_sample_interfaces::msg::DynamicSizeArray::SharedPtr message) {
        RCLCPP_INFO(
          rclcpp::get_logger("agnocast_sample_application"),
          "receive message id=%ld in group1 from /ros_topic_copy", message->id);
      },
      ros_options);
    ...
    sub_ros2_ = this->create_subscription<agnocast_sample_interfaces::msg::DynamicSizeArray>(
      "/ros_other_topic_copy", 1,
      [](const agnocast_sample_interfaces::msg::DynamicSizeArray::SharedPtr message) {
        RCLCPP_INFO(
          rclcpp::get_logger("agnocast_sample_application"),
          "receive message id=%ld in group2 from /ros_other_topic_copy", message->id);
      },
      ros_options2);
  }
};
