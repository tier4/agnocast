...
{
  // rclcpp::TimerBase is not supported in agnocast because:
  ...
  //
  // Use agnocast::Node::create_wall_timer() for timer functionality.
  throw std::runtime_error(
    "NodeTimers::add_timer is not supported in agnocast. "
    "rclcpp::Timer requires DDS infrastructure. "
    "Use agnocast::Node::create_wall_timer() instead.");
}
