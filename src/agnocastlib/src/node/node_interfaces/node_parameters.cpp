...
[[maybe_unused]] rcl_interfaces::msg::SetParametersResult __check_parameter_value_in_range(
...
[[maybe_unused]] auto __find_parameter_by_name(
  ParameterVectorType & parameters, const std::string & name)
{
