...
protected:
  ...
  const uint64_t NUM_ROS2_SUB_CBS = NUMBER_OF_ROS2_THREADS * 10;
  const uint64_t NUM_AGNOCAST_SUB_CBS = NUMBER_OF_AGNOCAST_THREADS * 10;
  const uint64_t NUM_AGNOCAST_CBS_TO_BE_ADDED = NUMBER_OF_AGNOCAST_THREADS * 5;
