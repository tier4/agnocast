...
{
  auto result = agnocast::parse_parameter_value("123");
...
{
  auto result = agnocast::parse_parameter_value("-456");
  EXPECT_EQ(result.get_type(), rclcpp::ParameterType::PARAMETER_INTEGER);
...
{
  auto result = agnocast::parse_parameter_value("true");
...
{
  auto result = agnocast::parse_parameter_value("FALSE");
  EXPECT_EQ(result.get_type(), rclcpp::ParameterType::PARAMETER_BOOL);
...
{
  auto result = agnocast::parse_parameter_value("3.14");
...
{
  auto result = agnocast::parse_parameter_value("1.5e10");
  EXPECT_EQ(result.get_type(), rclcpp::ParameterType::PARAMETER_DOUBLE);
...
{
  auto result = agnocast::parse_parameter_value("hello world");
...
{
  auto result = agnocast::parse_parameter_value("");
  EXPECT_EQ(result.get_type(), rclcpp::ParameterType::PARAMETER_STRING);
...
TEST(ParseParameterValueTest, parse_array_as_string)
{
  ...
  auto result = agnocast::parse_parameter_value("[1,2,3]");
  EXPECT_EQ(result.get_type(), rclcpp::ParameterType::PARAMETER_STRING);
...
TEST(ParseParameterValueTest, parse_node_prefix_as_string)
{
  ...
  auto result = agnocast::parse_parameter_value("/my_node:foo");
  EXPECT_EQ(result.get_type(), rclcpp::ParameterType::PARAMETER_STRING);
