...
CONFIG_PATH = os.path.join(os.path.dirname(__file__), 'config_test_1to1_with_ros2pub.yaml')
...
def calc_expect_pub_sub_num(config: dict) -> None:
    global EXPECT_INIT_ROS2_PUB_NUM, EXPECT_ROS2_PUB_NUM, EXPECT_INIT_PUB_NUM, EXPECT_PUB_NUM, EXPECT_INIT_ROS2_SUB_NUM, EXPECT_ROS2_SUB_NUM, EXPECT_INIT_SUB_NUM, EXPECT_SUB_NUM
...
def generate_test_description():
    ...
    is_bridge_from_ros2 = config['bridge_from_ros2']

    if is_bridge_from_ros2:
        pub_node_container = ComposableNodeContainer(
