...
#define TEST_CASES_RECEIVE_MSG                                                                    \
  KUNIT_CASE(test_case_no_topic_when_receive), KUNIT_CASE(test_case_no_subscriber_when_receive),  \
    ...
    KUNIT_CASE(test_case_one_new_pub), KUNIT_CASE(test_case_pubsub_in_same_process),              \
    KUNIT_CASE(test_case_2pub_in_same_process), KUNIT_CASE(test_case_2sub_in_same_process),       \
    KUNIT_CASE(test_case_too_many_mapping_processes)
