...
#define TEST_CASES_GET_EXT_SUBSCRIBER_NUM                         \
  KUNIT_CASE(test_case_get_ext_subscriber_num_normal),            \
    KUNIT_CASE(test_case_get_ext_subscriber_num_exclude_self),    \
    KUNIT_CASE(test_case_get_ext_subscriber_num_exclude_other),   \
