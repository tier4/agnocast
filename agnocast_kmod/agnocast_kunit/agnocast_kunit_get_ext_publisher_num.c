#include "agnocast_kunit_get_ext_publisher_num.h"
...
void test_case_get_ext_publisher_num_normal(struct kunit * test)
{
  ...
  union ioctl_get_ext_publisher_num_args args = {.exclude_pid = 0};
  int ret = get_ext_publisher_num(topic_name, current->nsproxy->ipc_ns, &args);
...
void test_case_get_ext_publisher_num_exclude_self(struct kunit * test)
{
  ...
  union ioctl_get_ext_publisher_num_args args = {.exclude_pid = target_pid};
  int ret = get_ext_publisher_num(topic_name, current->nsproxy->ipc_ns, &args);
...
void test_case_get_ext_publisher_num_exclude_other(struct kunit * test)
{
  ...
  union ioctl_get_ext_publisher_num_args args = {.exclude_pid = pid_a};
  int ret = get_ext_publisher_num(topic_name, current->nsproxy->ipc_ns, &args);
...
void test_case_get_ext_publisher_num_different_topic(struct kunit * test)
{
  ...
  union ioctl_get_ext_publisher_num_args args = {.exclude_pid = pid_topic2};
  int ret = get_ext_publisher_num(topic_1, current->nsproxy->ipc_ns, &args);
