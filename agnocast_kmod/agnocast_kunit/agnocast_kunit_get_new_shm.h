...
#define TEST_CASES_GET_NEW_SHM                                                              \
  KUNIT_CASE(test_case_get_new_shm_normal), KUNIT_CASE(test_case_get_new_shm_many),         \
    KUNIT_CASE(test_case_get_new_shm_not_aligned), KUNIT_CASE(test_case_get_new_shm_twice), \
    KUNIT_CASE(test_case_get_new_shm_too_big), KUNIT_CASE(test_case_get_new_shm_too_many)
