...
#define TEST_CASES_GET_FILTERED_PUBLISHER_NUM                         \
  KUNIT_CASE(test_case_get_filtered_publisher_num_normal),            \
    KUNIT_CASE(test_case_get_filtered_publisher_num_exclude_self),    \
    KUNIT_CASE(test_case_get_filtered_publisher_num_exclude_other),   \
    KUNIT_CASE(test_case_get_filtered_publisher_num_many),            \
    KUNIT_CASE(test_case_get_filtered_publisher_num_different_topic), \
    KUNIT_CASE(test_case_get_filtered_publisher_num_with_exit),       \
    KUNIT_CASE(test_case_get_filtered_publisher_num_no_publisher)
